"""External Agent Registry - Handles registration, storage, and management of external agents."""
...
import httpx
from agents.external_agent_adapter import ExternalAgentAdapter


class ExternalAgentRegistry:
    """Handles registration, storage, and management of external agents."""

    def __init__(self, registry_file: str = "external_agents_registry.json"):
